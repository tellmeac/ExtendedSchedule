...
func (tq *TeacherQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
...
func (tq *TeacherQuery) GroupBy(field string, fields ...string) *TeacherGroupBy {
	grbuild := &TeacherGroupBy{config: tq.config}
...
func (tq *TeacherQuery) Select(fields ...string) *TeacherSelect {
	...
	selbuild := &TeacherSelect{TeacherQuery: tq}
	selbuild.label = teacher.Label
